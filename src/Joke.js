        ...
        return (
            <div className="Joke">
                <div className="Joke-btn">
                    ...
                    <span className="Joke-vote" style={{ borderColor: this.changeColor() }}>{this.props.vote}</span>
                ...
                <div className="Joke-smiley">
                    <i className={this.changeEmoji()} aria-roledescription="presentation" aria-label="ROLLING ON THE FLOOR LAUGHING"></i>
                </div>
